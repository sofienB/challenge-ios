...
fileprivate let REQUEST_TIMEOUT = 10.0
...
public class Router<EndPoint: EndPointType>: NetworkRouter {
    ...
    fileprivate func buildRequest(from route: EndPoint) throws -> URLRequest {
        var request = URLRequest(url: route.baseURL.appendingPathComponent(route.path), cachePolicy: .reloadIgnoringLocalAndRemoteCacheData, timeoutInterval: REQUEST_TIMEOUT)
